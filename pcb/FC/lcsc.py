...
def main(argv=None):
    ...
    parser.add_argument("input_file", nargs="?", default="./hardware/fc/lcsc.txt", help="Path to file with one LCSC ID per line")
    parser.add_argument("output_dir", nargs="?", default="./hardware/fc/lib/lcsc", help="Output directory")
